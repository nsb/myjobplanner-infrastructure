...
resource "auth0_client" "myjobplanner-api-swagger-ui" {
  ...
  callbacks                           = ["https://api.myjobplanner.com/callback", "http://localhost:3000/callback", "http://localhost:3000/oauth2-redirect.html", "http://myjobplanner-api.*.sslip.io/oauth2-redirect.html"]
